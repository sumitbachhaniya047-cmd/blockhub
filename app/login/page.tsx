  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] items-center justify-center bg-paper px-4 py-16">
      <div className="w-full max-w-sm rounded-lg border border-line bg-white p-8 shadow-card">
        ...
        <p className="mt-1 text-sm text-ink-500">Log in to pick up your roadmap where you left off.</p>
        ...
        >
          <Field label="Email" icon={<Mail className="h-4 w-4" />} type="email" placeholder="you@college.edu" required />
          <Field label="Password" icon={<Lock className="h-4 w-4" />} type="password" placeholder="••••••••" required />

          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 text-ink-600">
              <input type="checkbox" className="h-4 w-4 rounded-sm border-line accent-teal-500" />
              Remember me
            </label>
